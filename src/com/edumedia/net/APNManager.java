...
public class APNManager {
	...
	public int isApnExisted(APN apnNode) {
		...
		while (mCursor != null && mCursor.moveToNext()) {
			...
			Log.e("isApnExisted", "info:" + apnId + "_" + name + "_" + apn+ "_" + type + "_" + current + "_" + proxy);// 遍历了所有的apn
	...
	public String matchAPN(String currentName) {
		...
		if (currentName.startsWith("cmnet") || currentName.startsWith("CMNET"))
			return "cmnet";
		else if (currentName.startsWith("cmwap")|| currentName.startsWith("CMWAP"))
			return "cmwap";
		else if (currentName.startsWith("3gwap")|| currentName.startsWith("3GWAP"))
			return "3gwap";
		else if (currentName.startsWith("3gnet")|| currentName.startsWith("3GNET"))
			return "3gnet";
		else if (currentName.startsWith("uninet")|| currentName.startsWith("UNINET"))
			return "uninet";
		else if (currentName.startsWith("uniwap")|| currentName.startsWith("UNIWAP"))
			return "uniwap";
		else if (currentName.startsWith("default")|| currentName.startsWith("DEFAULT"))
			return "default";
		else
			return "";
	}
	...
	public List<APN> getAPNList() {
		...
		Cursor cr = mContext.getContentResolver().query(APN_TABLE_URI, projection, null,null, null);
